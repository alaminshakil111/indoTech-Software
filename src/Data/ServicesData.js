...
import service2 from "../assets/images/services/softwareDev/softwareDev.avif";
...
import appsImage from "../assets/images/software/Apps-development.png"
...
export const servicesData = [
  {
    ...
    img: service3,
    title: "AI & Automation",
    subtitle: "We deliver intelligent, data-driven solutions that automate workflows, improve decision-making, and enhance productivity. Our AI systems are built with strong backend engineering, scalable cloud architecture, and modern machine learning frameworks. Whether you want predictive analytics, automated business processes, or virtual assistants—we design solutions that create measurable value.",
    details: {
  "AI Software & Machine Learning": {
    para1: "We build custom AI and Machine Learning systems that analyze data, make predictions, automate decision-making, and adapt over time. Our solutions integrate seamlessly with your existing applications through secure APIs and scalable infrastructure.",

    faq: [
      {
        question: "We want to leverage AI but don’t know where to start.",
        answer: "We help you identify use cases, define measurable goals, and create a clear AI roadmap."
      },
      {
        question: "Can you build AI that works with our current systems?",
        answer: "Yes. We integrate ML models into your applications through REST APIs, microservices, or standalone services."
      },
      {
        question: "Can your AI models handle large datasets?",
        answer: "Absolutely. We use scalable data pipelines, distributed training, and optimized storage strategies."
      },
      {
        question: "Will the model improve over time?",
        answer: "Yes. We implement retraining pipelines, continuous learning, and performance monitoring."
      },
      {
        question: "Are AI-driven decisions secure and compliant?",
        answer: "Yes. We follow strict data governance, anonymization, encryption, and compliance frameworks."
      }
    ],
    ...
    strengths: {
      ...
      items: [
        "Expertise in Python, TensorFlow, PyTorch, Scikit-learn, and ML Ops",
        "Ability to convert raw data into production-ready predictive models",
        "Secure and scalable backend integrations using Java-based microservices",
  ...
  "Business & Workflow Automation": {
    para1: "We automate repetitive tasks, streamline internal processes, and reduce operational costs using intelligent automation frameworks. From simple workflow triggers to fully automated business systems, we design solutions that eliminate manual work and improve efficiency.",

    faq: [
      {
        question: "Our internal processes are slow and manual—can you automate them?",
        answer: "Yes. We analyze your workflow, identify bottlenecks, and automate tasks using custom logic, APIs, and automation tools."
      },
      {
        question: "Can automation work across multiple systems like CRM, ERP, HRM, or custom software?",
        answer: "Yes. We build integrations across different platforms through APIs, webhooks, and middleware."
      },
      {
        question: "Will automation reduce human errors?",
        answer: "Yes. Automated workflows ensure consistent, error-free execution."
      },
      {
        question: "Can you automate document processing or approvals?",
        answer: "Yes. We implement automated forms, rule engines, OCR, and approval pipelines."
      },
      {
        question: "Can we track everything in real time?",
        answer: "Yes. Dashboards, notifications, analytics, and logs are included for full visibility."
      }
    ],
    ...
    strengths: {
      ...
      items: [
        "API-driven automation with Java microservices and cloud functions",
  ...
  "Virtual Assistants (AI Agents & Chatbots)": {
    para1: "We develop intelligent virtual assistants that automate customer support, streamline internal operations, and improve user engagement. Our AI agents can respond, process information, understand natural language, and integrate with your backend systems in real time.",

    faq: [
      {
        question: "Can you create a virtual assistant tailored to our business?",
        answer: "Yes. We design AI assistants that understand your workflows, FAQs, products, and operations."
      },
      {
        question: "Can the assistant handle both text and voice?",
        answer: "Yes. We support chatbots, voicebots, and multi-channel assistants."
      },
      {
        question: "Can it integrate with our CRM, database, or internal tools?",
        answer: "Yes. We connect assistants to APIs, knowledge bases, and custom systems."
      },
      {
        question: "Will the assistant improve as customers use it?",
        answer: "Yes. We use continuous learning, feedback loops, and analytics-based improvements."
      },
      {
        question: "Can the AI handle secure actions like ticket creation or order status checks?",
        answer: "Yes. We implement authentication, access control, and encrypted communication."
      }
    ],
  ...
  },
  {
    ...
    subtitle: "We aim to foster a stable, secure, and scalable IT environment where your operations run smoothly, your teams stay productive, and your technology continuously supports your business growth. Our managed services take full ownership of your IT ecosystem so you can stay focused on your core goals.",
    details: {
  "Network Management": {
    para1:
    ...
    faq: [
      {
        question: "Can you maintain a stable network across multiple locations?",
        answer:
  ...
  "Security Management": {
    ...
    faq: [
      ...
      {
        question: "Can you detect and respond to security incidents quickly?",
        answer:
    ...
    faq: [
      {
        ...
        answer:
          "We analyze current infrastructure, evaluate risks, and deliver actionable roadmaps.",
      },
      {
...

  {
    ...
    subtitle: "We deliver professional, reliable, and scalable software solutions powered by a clean Java backend architecture and a modern React/Next.js frontend stack. Our development process includes automated testing, CI/CD pipelines, and a predictable delivery workflow. We transform client requirements into production-ready applications supported by long-term maintenance and continuous improvement.",
    details: {
      "Web Development": {
        para1: "We build responsive, fast, and secure web applications using React, Next.js, and Java backend services. Whether you need a corporate website, SaaS platform, dashboard, or eCommerce solution—we deliver high-performance, scalable, and maintainable systems.",
        
        faq: [
          {
            question: "Can you make our website fast and SEO-friendly?",
            answer: "Yes. We optimize performance, implement structured data, and follow SEO and Core Web Vitals best practices."
          },
          {
            question: "Will our website work smoothly on all devices?",
            answer: "Yes. We ensure responsive layouts, adaptive UI, and full cross-browser compatibility."
          },
          {
            question: "Can you integrate payment gateways, CRM, ERP, or other APIs?",
            answer: "Yes. We handle REST and GraphQL APIs, OAuth authentication, and enterprise-level integrations."
          },
          {
            question: "Will we get admin panels or dashboards to manage content?",
            answer: "Yes. We develop custom admin portals or implement a headless CMS based on your needs."
          }
        ],
        ...
        items: [
          "Strong Java backend and React/Next.js frontend capability",
          "Clean and scalable architecture",
          "DevOps excellence: CI/CD pipelines, Docker, monitoring, and cloud deployment",
      ...
      "Mobile App Development": {
        para1: "We build native and cross-platform mobile apps with high performance, intuitive UX, and secure backend integrations. From prototyping to app store release, we manage the full lifecycle.",
        
        faq: [
        {
          question: "Should we build native or cross-platform?",
          answer: "Yes. We recommend the best option based on your budget, timeline, performance expectations, and device feature requirements."
        },
        {
          question: "How do you ensure the app performs well on all devices?",
          answer: "Yes. We test across multiple real devices, optimize memory usage, and follow native UI/UX guidelines."
        },
        {
          question: "Can the app work offline?",
          answer: "Yes. We implement offline mode, local caching, background sync, and efficient data handling."
        },
        {
          question: "Will you handle App Store/Play Store submission?",
          answer: "Yes. We manage metadata, screenshots, policies, guidelines, and the full approval process."
        },
        {
          question: "Can you integrate real-time features such as chat, tracking, or notifications?",
          answer: "Yes. We support Firebase, WebSockets, push notifications, and real-time data syncing."
        }
      ],
      ...
      strengths: {
        ...
        items: [
          "Expertise in Swift (iOS), Kotlin (Android), Flutter, and React Native",
  ...
  },
  {
    ...
    subtitle: "We help organizations implement Zero Trust principles to secure users, devices, applications, and data. By continuously verifying identities and controlling access, we reduce risk, prevent breaches, and protect critical assets.",
    details: {
      "Identity Security": {
        ...
        faq: [
          {
            question: "How can we make sure only legitimate users access our systems?",
            answer:
              "We implement multi-factor authentication (MFA), adaptive authentication, and conditional access policies.",
          },
          {
            question: "Can identity management integrate with cloud and on-premise systems?",
            answer:
              "Yes. We support hybrid environments, SSO, and identity federation.",
          },
          {
            question: "How do we monitor user activity for suspicious behavior?",
            answer:
      ...
      "Network Security (Micro-Segmentation)": {
        ...
        faq: [
          {
            question: "How can we prevent lateral movement of threats within our network?",
            answer:
      ...
      "Data Security": {
        ...
        faq: [
          {
            question: "How can we protect sensitive corporate and customer data?",
            answer:
              "We use encryption, tokenization, masking, and access policies.",
          },
          {
            question: "Can data protection extend to cloud and hybrid environments?",
            answer:
      ...
      "Analytics & Monitoring": {
        ...
        faq: [
          ...
          {
            question: "Can analytics help detect anomalies before they become threats?",
            answer:
