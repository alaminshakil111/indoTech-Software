...
import hybridSdWan from "../assets/images/solutions/sdWan/hybrid-sd-wan.jpg";
    ...
    details: {
      ...
      "Servers & Storage": {
        ...
        faq: [
          {
            question:
              "Can you provide reliable server and storage infrastructure?",
            answer:
    ...
    details: {
      "Data Network": {
        ...
        faq: [
          {
            question:
              "How can we ensure reliable connectivity across our offices?",
            answer:
              "We design resilient LAN/WAN networks with redundancy, load balancing and real-time monitoring.",
          },
          {
            question:
              "Can the network handle increased traffic as our business grows?",
            answer:
              "Yes. We implement scalable architectures and capacity planning for future growth.",
          },
          {
            question:
              "How do we ensure minimal downtime and fast issue resolution?",
            answer:
      ...
      "Audio and Video Solutions": {
        ...
        faq: [
          {
            question:
              "How can we implement professional audio and video systems?",
            answer:
      ...
      "Security Implementation": {
        ...
        faq: [
          ...
          {
            question:
              "Can security systems integrate with our existing infrastructure?",
            answer:
    ...
    details: {
      "Managed SD-WAN Solution": {
        ...
        faq: [
          ...
          {
            question:
              "Can this integrate with our existing network and cloud infrastructure?",
            answer:
    ...
    details: {
      ...
      "Wireless LAN / WiFi Solution": {
        ...
        faq: [
          {
            question:
              "How can we provide reliable Wi-Fi coverage across the office?",
            answer:
          ...
          {
            question:
              "Can the Wi-Fi network handle multiple users and devices?",
            answer:
      ...
      "Hybrid LAN + WiFi Solution": {
        ...
        faq: [
          {
            question:
              "How do we integrate wired and wireless networks securely?",
            answer:
      ...
      "Enterprise WiFi Solution (High-Density WiFi)": {
        ...
        faq: [
          {
            question:
              "How can we provide Wi-Fi for hundreds or thousands of users?",
            answer:
          ...
          {
            question:
              "How do we prevent interference and maintain performance?",
            answer:
      ...
      "Point-to-Point & Mesh WiFi Solution": {
        ...
        faq: [
          ...
          {
            question:
              "How do we ensure stable performance over long distances?",
            answer:
    ...
    details: {
      "IT Modernization & Cloud Adoption": {
        ...
        faq: [
          ...
          {
            question:
              "Can cloud adoption improve performance and reduce costs?",
            answer:
  ...
  },
  {
    ...
    details: {
      "AI Automation Systems": {
        ...
        para1:
          "We implement AI-driven automation to handle repetitive tasks, streamline workflows and reduce human error.",
        faq: [
          {
            question:
              "How can we automate internal business processes using AI?",
            answer:
              "We implement AI-powered RPA and workflow automation tools to handle tasks like approvals, data entry and reporting.",
          },
          {
            question: "Can AI automation integrate with existing systems?",
            answer:
              "Yes. We connect AI automation with ERP, CRM, HR and other enterprise applications.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "AI Predictive Analytics": {
        ...
        para1:
          "We turn internal data into actionable insights, forecasting trends, performance and operational outcomes.",
        faq: [
          {
            question: "How can we use AI to predict business trends?",
            answer:
              "We deploy predictive models using historical data to forecast performance, demand or risk factors.",
          },
          {
            question: "Can predictions be integrated into decision-making?",
            answer:
              "Yes. Insights feed into dashboards, planning tools and strategy platforms for proactive decision-making.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "AI Chatbots & Virtual Assistants (Internal Use)": {
        ...
        para1:
          "We provide AI-powered chatbots and virtual assistants for internal helpdesks, employee support and knowledge management.",
        faq: [
          {
            question: "Can we automate internal employee support?",
            answer:
              "Yes. AI chatbots answer FAQs, guide processes and escalate complex issues to humans.",
          },
          {
            question: "How do we ensure accuracy and relevance?",
            answer:
              "Continuous learning from interactions and integration with internal knowledge bases ensures high accuracy.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "Document Intelligence & AI OCR Systems": {
        ...
        para1:
          "We automate document processing, extract information and convert paper or digital documents into actionable data.",
        faq: [
          {
            question:
              "Can AI process large volumes of documents automatically?",
            answer:
              "Yes. AI OCR and document intelligence systems extract, categorize and store data efficiently.",
          },
          {
            question:
              "How accurate is the AI in reading and processing documents?",
            answer:
              "Advanced OCR and NLP models ensure high accuracy, even with unstructured or scanned documents.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "AI Recommendation & Decision Systems": {
        ...
        para1:
          "We provide AI systems that recommend actions, optimize workflows and assist internal decision-making.",
        faq: [
          {
            question: "Can AI suggest actions to improve efficiency?",
            answer:
              "Yes. Recommendation engines analyze internal data and provide actionable insights for processes, resources and performance.",
          },
          {
            question:
              "How do we ensure recommendations align with business rules?",
            answer:
              "AI systems are configured with organizational policies, KPIs and approval workflows.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "AI Monitoring & Security Intelligence": {
        ...
        para1:
          "We implement AI systems to monitor internal IT infrastructure, detect anomalies and strengthen security intelligence.",
        faq: [
          {
            question:
              "How can AI help monitor internal systems and detect threats?",
            answer:
              "AI continuously analyzes logs, user behavior and system metrics to detect anomalies or security threats.",
          },
          {
            question: "Can AI respond to incidents automatically?",
            answer:
              "Yes. Alerts, automated responses and escalation workflows enable proactive threat mitigation.",
          },
        ],
        strengths: {
          title: "Our Strengths",
  ...
  },
  {
    ...
    details: {
      "Cloud & Infrastructure Solutions": {
        ...
        para1:
          "We deliver scalable, secure and high-performance cloud and IT infrastructure solutions for global operations.",
        faq: [
          {
            question:
              "How can we manage cloud and infrastructure across multiple regions?",
            answer:
              "We deploy globally scalable cloud solutions (AWS, Azure, GCP) and manage infrastructure with centralized monitoring and optimization.",
          },
          {
            question: "Can we ensure performance and cost-efficiency?",
            answer:
              "Yes. Resource optimization, auto-scaling and monitoring ensure efficiency and reliability.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "Cybersecurity & Data Protection Solutions": {
        ...
        para1:
          "We secure global IT operations with comprehensive cybersecurity strategies and data protection systems.",
        faq: [
          {
            question: "How can we protect data across multiple countries?",
            answer:
              "We implement end-to-end encryption, access controls and compliance-aligned data protection.",
          },
          {
            question: "Can you monitor threats in real time?",
            answer:
              "Yes. Continuous monitoring, threat detection and AI-driven analytics protect your global operations.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "Business Process Automation Solutions": {
        ...
        para1:
          "We automate workflows and internal processes to optimize operations across global teams.",
        faq: [
          {
            question: "Can we streamline repetitive global business processes?",
            answer:
              "Yes. AI-driven automation and RPA streamline processes in HR, finance and operations.",
          },
          {
            question: "Can automation integrate with existing systems?",
            answer:
              "Yes. ERP, CRM and enterprise applications are fully integrated.",
          },
        ],
        strengths: {
          title: "Our Strengths",
      ...
      "Enterprise Software Solutions": {
        ...
        para1:
          "We develop and deploy scalable enterprise software for global operations, including ERP, CRM and custom platforms.",
        faq: [
          {
            question:
              "Can you deliver software that works across multiple regions?",
            answer:
              "Yes. We design multi-region SaaS, web and mobile enterprise applications with localization support.",
          },
          {
            question: "How do we ensure scalability and performance?",
            answer:
              "Modular architecture, cloud hosting and performance monitoring guarantee scalability.",
          },
        ],
        strengths: {
          title: "Our Strengths",
