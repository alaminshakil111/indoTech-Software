...
const computeResults = (q) => {
  ...
  return (
    <nav className="fixed top-0 left-0 w-full bg-white/20 dark:bg-gray-900/20 backdrop-blur-md shadow-md z-50">


      <div className="containerCustom flex items-center justify-between gap-4 px-4 py-4 lg:py-2">
      ...
      <div
        ref={mobileMenuRef}
        className={`lg:hidden fixed top-0 left-0 h-full w-[80%] max-w-[360px] bg-white dark:bg-gray-900 shadow-xl z-50 p-4 transition-transform duration-300 ${mobileOpen ? "translate-x-0" : "-translate-x-full"}`}
      >
        ...
        <ul className="space-y-3 text-[16px]">
          <li>
            <NavLink to="/" onClick={() => setMobileOpen(false)} className={({ isActive }) => (isActive || pathname === "/" ? "nav-link active-link" : "nav-link")}>Home</NavLink>
          </li>
          <li>
            <NavLink to="services/service-SoftwareDevelopment" onClick={() => setMobileOpen(false)} className={({ isActive }) => (isActive || pathname === "services/service-SoftwareDevelopment" ? "nav-link active-link" : "nav-link")}>Software Development</NavLink>
          </li>
          {menuData.map((menu) => (
            <MobileDropdown
              key={menu.title}
...
const DesktopDropdown = ({ menu, linkClass }) => {
  ...
  return (
    ...
    >
      <button className="textColor flex items-center gap-1">
        {menu.title} <FaChevronDown className={`transition ${open ? "rotate-180" : ""}`} />
      </button>

      {open && (
        <div className="absolute w-fit flex left-0 top-full bg-white dark:bg-gray-800 shadow-lg rounded-b-lg py-6 px-6 gap-4 animate-fadeSlide">
...
const MobileDropdown = ({ menu, mobileDropdown, setMobileDropdown, closeMenu, pathname }) => (
  <li>
    <button
      ...
      className="textColor flex items-center justify-between w-full"
    >
...
//   const { pathname } = useLocation(); // ✅ For mobile active state
...
//   // Close search & mobile when clicking outside
//   useEffect(() => {
//     function handleClick(e) {
//       if (searchRef.current && !searchRef.current.contains(e.target)) setSearchOpen(false);
//       if (mobileMenuRef.current && !mobileMenuRef.current.contains(e.target)) {
...
//             {/* Search */}
//             <div ref={searchRef} className="relative">
//               <FaSearch className="cursor-pointer textColor" onClick={() => setSearchOpen(!searchOpen)} />
//               {searchOpen && (
//                 <div className="absolute top-10 right-0 bg-white dark:bg-gray-800 shadow-md p-2 w-64 rounded-md">
//                   <input className="textColor w-full bg-transparent outline-none" type="search" placeholder="Search..." />
//                 </div>
//               )}
//             </div>
...
//       <div
//         ref={mobileMenuRef}
//         className={`lg:hidden fixed top-0 left-0 h-full w-[80%] max-w-[320px] bg-white dark:bg-gray-900 shadow-xl z-50 p-4 transition-transform duration-300
...
//               className={({ isActive }) => (isActive || pathname === "/" ? "nav-link active-link" : "nav-link")}
//             >
//               Home
//             </NavLink>
//           </li>
...
//               onClick={() => setMobileOpen(false)}
//               className={({ isActive }) =>
//                 isActive || pathname === "services/service-SoftwareDevelopment" ? "nav-link active-link" : "nav-link"
//               }
//             >
...
//               onClick={() => setMobileOpen(false)}
//               className={({ isActive }) =>
//                 isActive || pathname === "/about-us" ? "nav-link active-link" : "nav-link"
//               }
//             >
//               About Us
//             </NavLink>
...
//               onClick={() => setMobileOpen(false)}
//               className={({ isActive }) =>
//                 isActive || pathname === "/recruitment" ? "nav-link active-link" : "nav-link"
//               }
//             >
//               Recruitment
//             </NavLink>
...
//                 onClick={closeMenu}
//                 className={({ isActive }) =>
//                   isActive || pathname === sec.to ? "nav-link active-link" : "nav-link"
//                 }
//               >
//                 {sec.heading}
//               </NavLink>
...
//                     onClick={closeMenu}
//                     className={({ isActive }) =>
//                       isActive || pathname === item.to ? "nav-link active-link" : "nav-link"
//                     }
//                   >
//                     {item.label}
//                   </NavLink>
