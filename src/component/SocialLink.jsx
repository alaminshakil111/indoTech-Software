            ...
            <li>
                <NavLink to={s.link} key={i} target="_blank" className="relative group">
                    <div
                        ...
                        className="relative flex justify-center items-center after:left-[50%] after:top-[50%] after:transform after:-translate-[50%] after:h-[35px] after:w-[35px] md:after:h-[45px] md:after:w-[45px] after:content-[''] after:absolute after:inset-0 after:rounded-[5px] lg:after:rounded-[10px] after:bg-[var(--afterColor)] after:rotate-20 group-hover:after:rotate-0 after:transition-all after:duration-300 ">
                        <div className="relative z-[10] bg-white border border-gray-200 rounded-[5px] md:rounded-[10px] h-[30px] w-[30px] md:h-[40px] md:w-[40px] flex justify-center items-center text-xl shadow">
